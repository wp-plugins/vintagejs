...
<p>To add vintage effect to an image you select a preset filter during the image upload dialog and then insert iamge to post.</p>

<p><img src="<?php echo (WP_PLUGIN_URL . '/vintagejs/screenshot-1.png'); ?>"/></p>
</div>
